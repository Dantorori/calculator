...
function Opertators(props) {
  ...
  return (
    <div className='grid gap-3 grid-cols-4 bg-gray-100 p-5 rounded-b-lg'>
      <button className='icon' onClick={props.clearall}>AC</button>
      <button className='icon' onClick={props.clear}>C</button>
      <button className='icon'>%</button>
      <button value="/" className='icon col-start-4 row-start-1' onClick={props.oper}>/</button>
      <button value="*" className='icon col-start-4 row-start-2' onClick={props.oper}>*</button>
      <button value="-" className='icon col-start-4 row-start-3' onClick={props.oper}>-</button>
      <button value="+" className='icon col-start-4 row-start-4' onClick={props.oper}>+</button>
      <button className='icon col-start-3 col-span-2 row-start-5' onClick={props.calc}>=</button>
      ...
      <button value="." className='icon' onClick={props.oper}>.</button>
    </div>
  )
}
